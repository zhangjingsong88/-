  ...
  <div>
    ...
    <div class="block">
      <el-table :data="messageList">
        ...
        <el-table-column prop="id" v-model="id" label="图书编号"></el-table-column>
        <el-table-column prop="bookname" v-model="bookname" label="书名"></el-table-column>
        <el-table-column prop="author" v-model="author" label="作者"></el-table-column>
        <el-table-column prop="type" v-model="type" label="类型"></el-table-column>
        <el-table-column prop="publisher" v-model="publisher" label="出版商"></el-table-column>
        <el-table-column prop="stock" v-model="stock" label="库存"></el-table-column>
...
export default {
  ...
  mounted() {
    //获取
    this.$http({
      url: "/api/book/getlist"
    })
      .then(res => {
        console.log(res);
        this.messageList = [];
        this.bookname = res.data.bookname,
        this.author = messageList.author,
        this.type = messageList.type,
        this.publisher = messageList.publisher,
        this.tock = messageList.stock,
        console.log("success");
      })
      .catch(err => {
        console.log("error");
